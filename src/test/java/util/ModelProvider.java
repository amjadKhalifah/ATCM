...
public class ModelProvider {
	...
	public static FaultTreeDefinition faultTree1() {
		...
		List<ElementDefinition> elementDefinitions1 = new ArrayList<>(
				Arrays.asList(topDef, g1Def, g2Def, g3Def, g4Def, h1Def));
	...
	public static EMFTAFTAModel billySuzyEMFTA() {
		...
		EMFTAEvent notSh = new EMFTAEvent(EMFTAEvent.EMFTAEventType.Basic, "-SH", "Suzy does not hit", 0.0011D, null);
	...
	public static FaultTreeDefinition billySuzyMEF() {
		...
		List<ElementDefinition> elementDefinitions = new ArrayList<>(
				Arrays.asList(bsDef, bhDef, shDef, btDef, notShDef, stDef));
	...
	public static FaultTreeDefinition banking() {
		...
		FaultTreeDefinition banking = new FaultTreeDefinition("Transfer Money out of account", null, null,
				elementDefinitions);
		return banking;
	}
	...
	public static CausalModel testModel() {
		...
		BasicBooleanOperator and2 = new BasicBooleanOperator(BasicBooleanOperator.OperatorType.and,
				Arrays.asList(endo1));
		EndogenousVariable endo5 = new EndogenousVariable("endo5", and2);
		// endo2= endo1 and endo3 and endo4
		BasicBooleanOperator and = new BasicBooleanOperator(BasicBooleanOperator.OperatorType.and,
				Arrays.asList(endo3, endo4, endo1));
		...
		Set<Variable> variables = new HashSet<>(
				Arrays.asList(endo1, endo2, endo3, endo4, endo5, endo6, endo7, exo1, exo3, exo4));
		CausalModel billySuzy = new CausalModel("NewModel", variables);
		return billySuzy;
	}

	public static CausalModel basicORstructure() {
		// endo1 = exo1 endo3=exo3 endo4=exo4

		ExogenousVariable exo1 = new ExogenousVariable("exo1");
		EndogenousVariable endo1 = new EndogenousVariable("endo1", exo1, 0.0012);

		ExogenousVariable exo2 = new ExogenousVariable("exo2");
		EndogenousVariable endo2 = new EndogenousVariable("endo2", exo2, 0.0012);

		BasicBooleanOperator or1 = new BasicBooleanOperator(BasicBooleanOperator.OperatorType.or,
				Arrays.asList(endo1, endo2));
		EndogenousVariable endo3 = new EndogenousVariable("endo3", or1);

		Set<Variable> variables = new HashSet<>(Arrays.asList(endo1, endo2, endo3, exo1, exo2));
		CausalModel orModel = new CausalModel("OR-Model", variables);
		return orModel;
	}

	public static CausalModel basicANDstructure() {
		ExogenousVariable exo1 = new ExogenousVariable("exo1");
		EndogenousVariable endo1 = new EndogenousVariable("endo1", exo1, 0.0012);
		...
		BasicBooleanOperator and1 = new BasicBooleanOperator(BasicBooleanOperator.OperatorType.and,
				Arrays.asList(endo1, endo2));
		EndogenousVariable endo3 = new EndogenousVariable("endo3", and1);

		Set<Variable> variables = new HashSet<>(Arrays.asList(endo1, endo2, endo3, exo1, exo2));
		CausalModel orModel = new CausalModel("AND-Model", variables);
		return orModel;
	}
}
